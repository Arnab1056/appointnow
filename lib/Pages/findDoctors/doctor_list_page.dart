                  ...
                  return Container(
                    ...
                    child: Row(
                      children: [
                        CircleAvatar(
                          radius: 40,
                          backgroundImage: doctor['profileImageUrl'] != null && doctor['profileImageUrl'] != ''
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: const Icon(Icons.star, size: 14, color: Colors.teal),
                                    ),
                                    ...
                                    if (totalRatings > 0) ...[
                                      ...
                                      Text('($totalRatings)', style: const TextStyle(fontSize: 10, color: Colors.grey)),
                                    ]
                                  ],
                                ),
                              ),
