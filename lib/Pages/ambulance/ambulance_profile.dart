...
import 'package:appointnow/Pages/ambulance/ambulance_profile_edit.dart';
                  ...
                  child: StreamBuilder<DocumentSnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Column(
                        ...
                        mainAxisSize:
                            MainAxisSize.min, // Allow column to shrink
                        children: [
                          _buildListTile(Icons.edit, 'Edit Profile',
                              iconSize: 20.0,
                              iconColor: const Color(0xFF00B5A2), onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>
                                    AmbulanceProfileEditPage(),
                              ),
                            );
                          }),
                          _buildListTile(Icons.favorite_border, 'My reports',
                              iconSize: 20.0,
                              iconColor: const Color(0xFF00B5A2)),
                          _buildListTile(
